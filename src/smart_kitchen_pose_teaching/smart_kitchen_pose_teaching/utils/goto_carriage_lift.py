...
Usage:
  ros2 run smart_kitchen_pose_teaching goto_carriage_lift <position_name>

Examples:
  ros2 run smart_kitchen_pose_teaching goto_carriage_lift home
...
POSITIONS_PATH = (
    Path.home() / 'workspace' / 'smart_kitchen_ws' / 'src' / 'smart_kitchen_pose_teaching'
    / 'smart_kitchen_pose_teaching' / 'positions.toml'
)
...
def main(args=None):
    ...
    if carriage_target is None and lift_target is None:
        print(
            ...
            'Record them with: ros2 run smart_kitchen_pose_teaching record_position '
